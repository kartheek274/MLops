...
# installed.
TCL_PREFIX='C:/kartheek/Krish/myenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/kartheek/Krish/myenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/kartheek/Krish/myenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/kartheek/Krish/myenv\Library\include'
...
TCL_PACKAGE_PATH='C:/kartheek/Krish/myenv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/kartheek/Krish/myenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/kartheek/Krish/myenv\Library\lib\tclstub86.lib'
